...
![](https://github.com/patilninad/NIOS-II-Custom-Processor/blob/master/RTL%20viewer.PNG)  
   ...
   # 2.2.3) Technology Map Viewer (Post-Fitting):-  
  ...
  # 2.2.4) ModelSim:-  
   ...
   # 2.2.5) TimeQuest Timing Analyser:-  
   ...
   # 3) Intel(Altera) FPGA's configuration modes:-  
